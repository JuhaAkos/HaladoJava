...
public class StreamConverterTest {
	...
	CalendarConverter CalendarConverterStreams = new CalendarConverter();
	
	@Test
	public void testCalendarNull(){
		List<Job> jobList = new ArrayList<Job>();
		jobList = CalendarConverterStreams.from(null);
	...
	public void testCalendarOne(){
		...
		List<Job> jobList = new ArrayList<Job>();
		jobList = CalendarConverterStreams.from(calendarList);
